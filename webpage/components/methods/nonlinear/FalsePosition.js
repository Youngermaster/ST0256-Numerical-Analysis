...
function NonlinearFalsePosition({methodName, markdown}) {
    ...
    if (lowerX >= upperX) {
        intervalError = true;
        lowerXErrorText = "a debe ser menos que b!";
        upperXErrorText = "b debe ser mayor que a!";
    }
    ...
    if (isNaN(errorThreshold)) {
        ...
        thresholdError = true;
        thresholdErrorText = "No puede ser negativo!";
    }
    ...
    if (isValidMath(functionValue) && !hasError) {
        ...
        while (true) {
            ...
            try {
                ...
                hasError = true;
                functionError = true;
                functionErrorText = "Solo la variable x es permitdia!";
                solve = false;
                break;
            }
            let rootFound = false;
            ...
            if (i > 1000) {
                ...
                exceedIterErrorText = "Excede las 1000 iteraciones!";
                break;
            }
        }
        iterations = i;
                    ...
                    <Grid xs item>
                        <Zoom triggerOnce>
                            <Card className={styleClasses.card}>
                                <CardContent className={styleClasses.cardContent}>
                                    <Typography variant="h6">
                                        Converge depues de {params.iterations} iteraciones
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Zoom>
