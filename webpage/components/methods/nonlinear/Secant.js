...
function NonlinearSecant({methodName, markdown}) {
    ...
    if (perturbation <= 0) {
        ...
        perturbationErrorText = "Perturbacion debe ser positiva!";
    }
    ...
    if (!Number.isInteger(iterations) || iterations <= 0) {
        iterError = true;
        iterErrorText = "Las iteraciones deben ser positivias!";
    }
    ...
    if (isNaN(initialX)) {
        initialXError = true;
        initialXErrorText = "X inicial debe ser positiva!";
    }
                    ...
                    <Grid container spacing={1} direction="row" alignItems="center" justify="center">
                        ...
                        <Grid xs item className="perturbation-input">
                            <Card className={styleClasses.card}>
                                <CardContent className={styleClasses.cardContent}>
                                    <Typography variant="h6">
                                        Fracción de perturbación, <TeX math={String.raw`\delta`} />:
                                    </Typography>
                                    <TextField
                                        disabled={false}
                                        type="number"
